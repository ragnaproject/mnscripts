...
COIN_TGZ='https://github.com/ragnaproject/Ragnarok/releases/download/v3.1.4/ragnarok-3.1.4-x86_64-linux.zip'
...
addnode=88.198.159.210
addnode=138.201.89.14
EOF
}
...
function important_information() {
 ...
 echo -e "${YELLOW}=====================================================================================${NC}"
 echo -e "${RED}Donations are always welcome.${NC}"
 echo -e "${YELLOW}=====================================================================================${NC}"
 echo -e "${GREEN}RAGNA: rJDghSNmXvjEVQBV1n5ta5wmXfD3gvCrYc${NC}"
 echo -e "${YELLOW}=====================================================================================${NC}"
