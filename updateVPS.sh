...
wget https://github.com/ragnaproject/Ragnarok/releases/download/v3.1.4/ragnarok-3.1.4-x86_64-linux-static.tar.gz
...
wget https://github.com/ragnaproject/bootstrap/releases/download/v3.1.4/bootstrap.tar.gz
